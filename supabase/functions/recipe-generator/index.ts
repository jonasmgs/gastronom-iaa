...
function buildPrompt(body: Record<string, unknown>, ingredients: string[]) {
  ...
  const systemPrompt = [
    ...
    "Utilize EXCLUSIVAMENTE medidas de peso (g, kg) ou volume (ml, l).",
    "É PROIBIDO o uso de 'unidade', 'un', 'xícara', 'colher', 'fatia' ou qualquer outra medida que não seja g, kg, ml ou l.",
    "Até mesmo ingredientes como ovos, dentes de alho ou fatias de pão devem ser convertidos para gramas ou ml (ex: 100g de ovos em vez de 2 unidades).",
