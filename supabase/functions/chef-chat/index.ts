...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = [
      ...
      "1. NUNCA use as unidades 'unidade', 'un', 'fatia', 'dente' ou qualquer medida subjetiva.",
      ...
      "4. Se o usuário perguntar sobre um ingrediente em unidades, converta para gramas na sua resposta (ex: 'Use 50g de cebola' em vez de 'meia cebola').",
      "5. Você pode explicar a equivalência no texto (ex: '50g, que é meia cebola média'), mas a medida principal deve ser métrica.",
