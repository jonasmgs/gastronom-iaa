...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = [
      ...
      "Ao sugerir ingredientes ou substituicoes, utilize EXCLUSIVAMENTE medidas de peso (g, kg) ou volume (ml, l) para as quantidades.",
      "É terminantemente PROIBIDO o uso de 'unidade', 'un', 'xícara', 'colher', 'fatia', 'dente' nas medidas. Converta tudo para gramas ou mililitros.",
      "Você PODE e deve explicar a equivalência no texto da resposta (ex: 'Sugiro usar 100g de ovos, que equivale a 2 unidades médias') para facilitar a compreensão do usuário.",
