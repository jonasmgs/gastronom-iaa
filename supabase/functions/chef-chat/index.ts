...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = [
      ...
      "Ao sugerir ingredientes ou substituicoes, utilize EXCLUSIVAMENTE medidas de peso (g, kg) ou volume (ml, l).",
      "É terminantemente PROIBIDO o uso de 'unidade', 'un', 'xícara', 'colher', 'fatia', 'dente' ou qualquer medida subjetiva. Converta tudo para gramas ou mililitros.",
